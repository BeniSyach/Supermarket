<?php
    ...
    ?>
        <script>
        window.alert("Tidak ada barang yang di belanja!!");
        </script>
    <?php
    }else{
        ...
        <div>
            ...
            <div class="container">
                <table class="table table-bordered table-striped">
                    <tbody>
                        <tr>
                            <th>No Barang</th><th>Nama Barang</th><th>Harga</th><th></th>
                        </tr>
                       <?php 
                        $user_products_result=mysqli_query($con,$user_products_query) or die(mysqli_error($con));
                        $no_of_user_products= mysqli_num_rows($user_products_result);
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rp <?php echo $sum;?>/-</th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Kode Konfirmasi</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
