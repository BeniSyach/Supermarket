<?php
    ...
    if(!preg_match($regex_email,$email)){
        echo "Email yang anda isi Salah Masukkan Email yang Betul";
        ?>
    ...
    if(strlen($password)<6){
        echo "kata Sandi Harus 6 Karakter";
        ?>
        <meta http-equiv="refresh" content="2;url=signup.php" />
        <?php
    }
    ...
    if($rows_fetched>0){
        ...
        ?>
        <script>
            window.alert("Email sudah ada yang punya");
        </script>
        ...
        echo "Anda Berhasil Di Daftarkan";
